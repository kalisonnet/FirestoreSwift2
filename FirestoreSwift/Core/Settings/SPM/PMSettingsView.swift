    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                // Appearance Section
                Section {
                    NavigationLink(destination: AppearanceView(appearanceSelection: $appearanceSelection)) {
                        HStack {
...
struct AppearanceView: View {
    @Binding var appearanceSelection: PMSettingsView.AppearanceOption
    ...
    private func updateAppearance(_ option: PMSettingsView.AppearanceOption) {
