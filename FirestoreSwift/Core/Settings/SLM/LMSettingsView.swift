    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                // Appearance Section
                Section {
                    NavigationLink(destination: LMAppearanceView(appearanceSelection: $appearanceSelection)) {
                        HStack {
...
// Appearance View
struct LMAppearanceView: View {
    @Binding var appearanceSelection: LMSettingsView.AppearanceOption
    ...
    private func updateAppearance(_ option: LMSettingsView.AppearanceOption) {
